...
export const terms: LegalDoc = {
  ...
  blocks: [
    ...
    { kind: "p", text: "You must be at least 13 years old, and older if your country sets a higher minimum age for this kind of service. You must not be barred from using it under any applicable law. One account is for one person — do not share your account or your device credentials." },
...
export const childSafety: LegalDoc = {
  ...
  blocks: [
    ...
    { kind: "p", text: "cookd is not directed at children. You must be at least 13 years old to use cookd, and older where your country requires it. We remove accounts we determine belong to someone under the minimum age." },
